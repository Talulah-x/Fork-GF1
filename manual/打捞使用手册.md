...
将地图缩放至最小，并从右往左拖拽至无法移动 且 效能435怪组所在机场与下边界相切
...
将地图缩放至最小，脚本中在初次运行添加了滑动操作，因此无需特别调整。推荐在3-4E中打捞，稳定2战；若是在3-6中则是3战需要调整延迟，增加容忍值范围。

注意：若是采用默认路线，则有可能因为随机事件而多一战，因此也需要自行调整时间。
